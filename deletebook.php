...
<form action = "" method = "post" id = "bookentry" class="form-horizontal">
    <fieldset><legend>Delete a Book Record</legend>
       <div class ="form-group">
       <label for="BookID" class="col-sm-2 control-label">BookID</label>
       <div class="col-sm-10">
        <input type="text" name="BookID" id="BookID"  class="form-control"  maxlength="9" readonly value = "<?php echo $BookID ?>">
       </div>
     </div>
	 ...
	 <div class ="form-group">
       ...
       <div class="col-sm-10">
        <input type="text" name="Synopsis" id="Synopsis" class="form-control" readonly value = "<?php echo $Synopsis; ?>">
       </div>
     </div>
...
<div class="buttonarea">
    		<input type="submit" value="Delete Book  Record" name = "Submit" onclick="return confirm('Are you sure to delete this recor?')">
