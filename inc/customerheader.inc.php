...
<html lang="en">
  <head>
    ...
    <title>Site Customer Access</title>
...
<h1>Customer Database Access</h1>
</header>
</div>
...
<li class="dropdown">
<a href="#" class="dropdown-toggle" data-toggle="dropdown">Customer Retrieval<b class="caret"></b></a>
<ul class="dropdown-menu">
<?php $action=false;?>
...
<ul class="dropdown-menu">
<li><a href="inscust.php">Insert a New Customer</a></li>
</ul></li>
...
<ul class="dropdown-menu">
<?php $action=true;?>
<li><a href="customer.php?edit=<?php echo $action; ?>">Update/Delete a Customer</a></li>
</ul></li>
</li>
<li class="dropdown">
